...
import random
import glob
img_dir = r"C:/Users/Administrator/PycharmProjects/bishe/MyDesign/test/trhsth.PNG" #存放未清洗图片的路径
save_dir = r"C:/Users/Administrator/PycharmProjects/bishe/MyDesign/test/" #存放清洗后数据
def split(jpg_file):
